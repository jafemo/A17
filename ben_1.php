...
<html>
  <head>
    <meta charset="utf-8">
    <title>Documento con los beneficios de la semana 1</title>
  </head>
  <body>
    <?php
//////////CONEXIÓN//////////
...
//////////Hacemos las dos consultas//////////
      $resultado1 = $mysqli->query(" SELECT * FROM gastos WHERE num_semana=1");
      $resultado2 = $mysqli->query(" SELECT * FROM ventas WHERE num_semana=1");
      ?>
...
//////////ABRIMOS EL PHP PARA REALIZAR LAS OPERACIONES NECESARIAS//////////
     ...
     echo "Los beneficios de la semana 1 son: ".$beneficio;
    }
?>
  </body>
</html>
